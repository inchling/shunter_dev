...
!function (t, e) {
    ...
    t.module("smart-table", []).run(["$templateCache", function (t) {
        ...
        return {
            restrict: "EA",
            require: "^stTable",
            scope: {stItemsByPage: "=?", stDisplayedPages: "=?", stPageChange: "&",toCleanState:'&'},
            ...
            link: function (e, a, n, s) {
                ...
                e.stItemsByPage = e.stItemsByPage ? +e.stItemsByPage : t.pagination.itemsByPage, e.stDisplayedPages = e.stDisplayedPages ? +e.stDisplayedPages : t.pagination.displayedPages, e.currentPage = 1, e.pages = [], e.$watch(function () {
                    ...
                    if(t > 0 && t <= e.numPages && s.slice((t - 1) * e.stItemsByPage, e.stItemsByPage)){
                        e.toCleanState() ? e.toCleanState()() : '';e.toPage='';
                    }
                }, s.tableState().pagination.number || s.slice(0, e.stItemsByPage),e.gotoPage=function(ev,t){
                    if(ev.keyCode===13){
                        t>0 && t <= e.numPages && s.slice((t - 1) * e.stItemsByPage, e.stItemsByPage);e.toPage='';
                    }
                }
            }
        }
